...
| --- | --- | --- | --- | ---: |
| hello_world | `--optimize=off` | core (command) | Preview 1 | 372,470 |
...
| pi_approx | `--optimize=off` | core (command) | Preview 1 | 372,838 |
...
| zlib | `--optimize=off` | core (command) | Preview 1 | 570,852 |
| zlib | `--optimize` | core (command) | Preview 1 | 104,745 |
| zlib | `--optimize=size` | core (command) | Preview 1 | 78,958 |
| zlib | `--component --optimize=size` | component (command) | Preview 3 | 83,127 |
| dom_reactor | `--no-wasi --optimize=off` | core (reactor) | none | 374,158 |
