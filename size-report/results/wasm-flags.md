...
| --- | --- | --- | --- | ---: |
| hello_world | `--optimize=off` | core (command) | Preview 1 | 244,936 |
...
| pi_approx | `--optimize=off` | core (command) | Preview 1 | 245,304 |
...
| zlib | `--optimize=off` | core (command) | Preview 1 | 462,894 |
| zlib | `--optimize` | core (command) | Preview 1 | 116,920 |
| zlib | `--optimize=size` | core (command) | Preview 1 | 89,499 |
| zlib | `--component --optimize=size` | component (command) | Preview 3 | 93,557 |
| dom_reactor | `--no-wasi --optimize=off` | core (reactor) | none | 246,624 |
