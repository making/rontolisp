...
| --- | --- | --- | --- | ---: |
| hello_world | `--optimize=off` | core (command) | Preview 1 | 147,751 |
...
| pi_approx | `--optimize=off` | core (command) | Preview 1 | 148,092 |
...
| zlib | `--optimize=off` | core (command) | Preview 1 | 351,227 |
| zlib | `--optimize` | core (command) | Preview 1 | 123,277 |
| zlib | `--optimize=size` | core (command) | Preview 1 | 97,920 |
| zlib | `--component --optimize=size` | component (command) | Preview 3 | 101,098 |
