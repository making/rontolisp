...
| --- | --- | --- | --- | ---: |
| hello_world | `--optimize=off` | core (command) | Preview 1 | 371,724 |
...
| pi_approx | `--optimize=off` | core (command) | Preview 1 | 372,092 |
| pi_approx | `--optimize` | core (command) | Preview 1 | 2,372 |
...
| zlib | `--optimize=off` | core (command) | Preview 1 | 564,853 |
| zlib | `--optimize` | core (command) | Preview 1 | 100,871 |
| zlib | `--optimize=size` | core (command) | Preview 1 | 76,150 |
| zlib | `--component --optimize=size` | component (command) | Preview 3 | 80,281 |
| dom_reactor | `--no-wasi --optimize=off` | core (reactor) | none | 373,412 |
| dom_reactor | `--no-wasi --optimize` | core (reactor) | none | 2,873 |
| dom_reactor | `--no-wasi --optimize=size` | core (reactor) | none | 2,584 |
