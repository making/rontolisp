...
| zlib | `--optimize=off` | core (command) | Preview 1 | 419,690 |
| zlib | `--optimize` | core (command) | Preview 1 | 152,257 |
| zlib | `--optimize=size` | core (command) | Preview 1 | 124,595 |
| zlib | `--component --optimize=size` | component (command) | Preview 3 | 128,533 |
