...
| zlib | (none) | core (command) | Preview 1 | 318,219 |
| zlib | `--optimize` | core (command) | Preview 1 | 133,833 |
| zlib | `--optimize=size` | core (command) | Preview 1 | 105,393 |
| zlib | `--component --optimize=size` | component (command) | Preview 3 | 109,899 |
