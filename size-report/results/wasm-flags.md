...
| --- | --- | --- | --- | ---: |
| hello_world | `--optimize=off` | core (command) | Preview 1 | 240,985 |
...
| pi_approx | `--optimize=off` | core (command) | Preview 1 | 241,353 |
...
| zlib | `--optimize=off` | core (command) | Preview 1 | 435,319 |
| zlib | `--optimize` | core (command) | Preview 1 | 107,856 |
| zlib | `--optimize=size` | core (command) | Preview 1 | 81,970 |
| zlib | `--component --optimize=size` | component (command) | Preview 3 | 86,137 |
| dom_reactor | `--no-wasi --optimize=off` | core (reactor) | none | 242,673 |
