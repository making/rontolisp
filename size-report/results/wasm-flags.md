...
| --- | --- | --- | --- | ---: |
| hello_world | `--optimize=off` | core (command) | Preview 1 | 160,775 |
...
| pi_approx | `--optimize=off` | core (command) | Preview 1 | 160,975 |
...
| zlib | `--optimize=off` | core (command) | Preview 1 | 352,847 |
| zlib | `--optimize` | core (command) | Preview 1 | 123,655 |
| zlib | `--optimize=size` | core (command) | Preview 1 | 98,135 |
| zlib | `--component --optimize=size` | component (command) | Preview 3 | 101,280 |
