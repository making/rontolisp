...
| --- | --- | --- | --- | ---: |
| hello_world | `--optimize=off` | core (command) | Preview 1 | 164,174 |
| hello_world | `--optimize` | core (command) | Preview 1 | 596 |
| hello_world | `--optimize=size` | core (command) | Preview 1 | 596 |
| hello_world | `--component --optimize=size` | component (command) | Preview 3 | 1,752 |
| hello_world (nogc source) | `--no-gc --optimize=size` | core (reactor) | Preview 1 | 406 |
| pi_approx | `--optimize=off` | core (command) | Preview 1 | 164,515 |
| pi_approx | `--optimize` | core (command) | Preview 1 | 4,996 |
| pi_approx | `--optimize=size` | core (command) | Preview 1 | 4,595 |
| pi_approx | `--component --optimize=size` | component (command) | Preview 3 | 5,728 |
| pi_approx (nogc source) | `--no-gc --optimize=size` | core (reactor) | Preview 1 | 3,442 |
| zlib | `--optimize=off` | core (command) | Preview 1 | 374,091 |
| zlib | `--optimize` | core (command) | Preview 1 | 129,321 |
| zlib | `--optimize=size` | core (command) | Preview 1 | 103,592 |
| zlib | `--component --optimize=size` | component (command) | Preview 3 | 107,096 |
