...
| --- | --- | --- | --- | ---: |
| hello_world | `--optimize=off` | core (command) | Preview 1 | 240,386 |
...
| pi_approx | `--optimize=off` | core (command) | Preview 1 | 240,754 |
...
| zlib | `--optimize=off` | core (command) | Preview 1 | 431,583 |
| zlib | `--optimize` | core (command) | Preview 1 | 106,621 |
| zlib | `--optimize=size` | core (command) | Preview 1 | 80,863 |
| zlib | `--component --optimize=size` | component (command) | Preview 3 | 84,814 |
| dom_reactor | `--no-wasi --optimize=off` | core (reactor) | none | 242,074 |
