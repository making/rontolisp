...
| --- | --- | --- | --- | ---: |
| hello_world | `--optimize=off` | core (command) | Preview 1 | 156,420 |
...
| pi_approx | `--optimize=off` | core (command) | Preview 1 | 156,761 |
| pi_approx | `--optimize` | core (command) | Preview 1 | 4,995 |
| pi_approx | `--optimize=size` | core (command) | Preview 1 | 4,594 |
| pi_approx | `--component --optimize=size` | component (command) | Preview 3 | 5,727 |
| pi_approx (nogc source) | `--no-gc --optimize=size` | core (reactor) | Preview 1 | 3,442 |
| zlib | `--optimize=off` | core (command) | Preview 1 | 363,492 |
| zlib | `--optimize` | core (command) | Preview 1 | 128,251 |
| zlib | `--optimize=size` | core (command) | Preview 1 | 102,630 |
| zlib | `--component --optimize=size` | component (command) | Preview 3 | 106,124 |
