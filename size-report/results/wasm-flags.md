...
| --- | --- | --- | --- | ---: |
| hello_world | (none) | core (command) | Preview 1 | 127,526 |
...
| pi_approx | (none) | core (command) | Preview 1 | 127,726 |
...
| zlib | (none) | core (command) | Preview 1 | 308,140 |
| zlib | `--optimize` | core (command) | Preview 1 | 109,947 |
| zlib | `--optimize=size` | core (command) | Preview 1 | 85,470 |
| zlib | `--component --optimize=size` | component (command) | Preview 3 | 88,638 |
