...
| --- | --- | --- | --- | ---: |
| hello_world | `--optimize=off` | core (command) | Preview 1 | 148,969 |
...
| pi_approx | `--optimize=off` | core (command) | Preview 1 | 149,310 |
...
| zlib | `--optimize=off` | core (command) | Preview 1 | 352,476 |
| zlib | `--optimize` | core (command) | Preview 1 | 123,713 |
| zlib | `--optimize=size` | core (command) | Preview 1 | 98,356 |
| zlib | `--component --optimize=size` | component (command) | Preview 3 | 101,533 |
