...
| --- | --- | --- | --- | ---: |
| hello_world | `--optimize=off` | core (command) | Preview 1 | 306,864 |
...
| pi_approx | `--optimize=off` | core (command) | Preview 1 | 307,232 |
...
| zlib | `--optimize=off` | core (command) | Preview 1 | 516,375 |
| zlib | `--optimize` | core (command) | Preview 1 | 106,726 |
| zlib | `--optimize=size` | core (command) | Preview 1 | 80,885 |
| zlib | `--component --optimize=size` | component (command) | Preview 3 | 85,009 |
| dom_reactor | `--no-wasi --optimize=off` | core (reactor) | none | 308,552 |
| dom_reactor | `--no-wasi --optimize` | core (reactor) | none | 2,955 |
