...
| --- | --- | --- | --- | ---: |
| hello_world | `--optimize=off` | core (command) | Preview 1 | 177,624 |
...
| pi_approx | `--optimize=off` | core (command) | Preview 1 | 177,966 |
| pi_approx | `--optimize` | core (command) | Preview 1 | 4,997 |
| pi_approx | `--optimize=size` | core (command) | Preview 1 | 4,596 |
| pi_approx | `--component --optimize=size` | component (command) | Preview 3 | 5,729 |
| pi_approx (nogc source) | `--no-gc --optimize=size` | core (reactor) | Preview 1 | 3,442 |
| zlib | `--optimize=off` | core (command) | Preview 1 | 399,373 |
| zlib | `--optimize` | core (command) | Preview 1 | 145,692 |
| zlib | `--optimize=size` | core (command) | Preview 1 | 117,907 |
| zlib | `--component --optimize=size` | component (command) | Preview 3 | 121,803 |
