...
| --- | --- | --- | --- | ---: |
| hello_world | `--optimize=off` | core (command) | Preview 1 | 156,647 |
...
| pi_approx | `--optimize=off` | core (command) | Preview 1 | 156,847 |
...
| zlib | `--optimize=off` | core (command) | Preview 1 | 347,228 |
| zlib | `--optimize` | core (command) | Preview 1 | 122,300 |
| zlib | `--optimize=size` | core (command) | Preview 1 | 96,781 |
| zlib | `--component --optimize=size` | component (command) | Preview 3 | 99,924 |
