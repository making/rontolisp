...
| --- | --- | --- | --- | ---: |
| hello_world | `--optimize=off` | core (command) | Preview 1 | 149,889 |
| hello_world | `--optimize` | core (command) | Preview 1 | 595 |
| hello_world | `--optimize=size` | core (command) | Preview 1 | 595 |
| hello_world | `--component --optimize=size` | component (command) | Preview 3 | 1,751 |
| hello_world (nogc source) | `--no-gc --optimize=size` | core (reactor) | Preview 1 | 406 |
| pi_approx | `--optimize=off` | core (command) | Preview 1 | 150,230 |
| pi_approx | `--optimize` | core (command) | Preview 1 | 3,316 |
| pi_approx | `--optimize=size` | core (command) | Preview 1 | 2,915 |
| pi_approx | `--component --optimize=size` | component (command) | Preview 3 | 4,071 |
| pi_approx (nogc source) | `--no-gc --optimize=size` | core (reactor) | Preview 1 | 3,442 |
| zlib | `--optimize=off` | core (command) | Preview 1 | 355,616 |
| zlib | `--optimize` | core (command) | Preview 1 | 126,714 |
| zlib | `--optimize=size` | core (command) | Preview 1 | 101,095 |
| zlib | `--component --optimize=size` | component (command) | Preview 3 | 104,291 |
