...
| --- | --- | --- | --- | ---: |
| hello_world | (none) | core (command) | Preview 1 | 121,679 |
| hello_world | `--optimize` | core (command) | Preview 1 | 526 |
| hello_world | `--optimize=size` | core (command) | Preview 1 | 526 |
| hello_world | `--component --optimize=size` | component (command) | Preview 3 | 1,680 |
| hello_world (nogc source) | `--no-gc --optimize=size` | core (reactor) | Preview 1 | 406 |
| pi_approx | (none) | core (command) | Preview 1 | 121,879 |
| pi_approx | `--optimize` | core (command) | Preview 1 | 2,793 |
| pi_approx | `--optimize=size` | core (command) | Preview 1 | 2,793 |
| pi_approx | `--component --optimize=size` | component (command) | Preview 3 | 3,920 |
| pi_approx (nogc source) | `--no-gc --optimize=size` | core (reactor) | Preview 1 | 1,042 |
| zlib | (none) | core (command) | Preview 1 | 291,901 |
| zlib | `--optimize` | core (command) | Preview 1 | 95,718 |
| zlib | `--optimize=size` | core (command) | Preview 1 | 72,754 |
| zlib | `--component --optimize=size` | component (command) | Preview 3 | 74,408 |
