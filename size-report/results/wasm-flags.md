...
| --- | --- | --- | --- | ---: |
| hello_world | `--optimize=off` | core (command) | Preview 1 | 305,268 |
...
| pi_approx | `--optimize=off` | core (command) | Preview 1 | 305,636 |
...
| zlib | `--optimize=off` | core (command) | Preview 1 | 507,010 |
| zlib | `--optimize` | core (command) | Preview 1 | 105,732 |
| zlib | `--optimize=size` | core (command) | Preview 1 | 79,945 |
| zlib | `--component --optimize=size` | component (command) | Preview 3 | 84,065 |
| dom_reactor | `--no-wasi --optimize=off` | core (reactor) | none | 306,956 |
