...
| --- | --- | --- | --- | ---: |
| hello_world | `--optimize=off` | core (command) | Preview 1 | 148,193 |
...
| pi_approx | `--optimize=off` | core (command) | Preview 1 | 148,534 |
...
| zlib | `--optimize=off` | core (command) | Preview 1 | 351,671 |
| zlib | `--optimize` | core (command) | Preview 1 | 123,281 |
| zlib | `--optimize=size` | core (command) | Preview 1 | 97,924 |
| zlib | `--component --optimize=size` | component (command) | Preview 3 | 101,102 |
