...
| --- | --- | --- | --- | ---: |
| hello_world | (none) | core (command) | Preview 1 | 152,080 |
...
| pi_approx | (none) | core (command) | Preview 1 | 152,280 |
...
| zlib | (none) | core (command) | Preview 1 | 336,143 |
| zlib | `--optimize` | core (command) | Preview 1 | 117,394 |
| zlib | `--optimize=size` | core (command) | Preview 1 | 92,586 |
| zlib | `--component --optimize=size` | component (command) | Preview 3 | 95,736 |
