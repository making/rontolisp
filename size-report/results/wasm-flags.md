...
| --- | --- | --- | --- | ---: |
| hello_world | `--optimize=off` | core (command) | Preview 1 | 371,262 |
...
| pi_approx | `--optimize=off` | core (command) | Preview 1 | 371,630 |
...
| zlib | `--optimize=off` | core (command) | Preview 1 | 563,824 |
...
| dom_reactor | `--no-wasi --optimize=off` | core (reactor) | none | 372,950 |
