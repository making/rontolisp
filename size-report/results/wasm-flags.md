...
| --- | --- | --- | --- | ---: |
| hello_world | (none) | core (command) | Preview 1 | 122,321 |
...
| pi_approx | (none) | core (command) | Preview 1 | 122,521 |
| pi_approx | `--optimize` | core (command) | Preview 1 | 2,878 |
| pi_approx | `--optimize=size` | core (command) | Preview 1 | 2,878 |
...
| zlib | (none) | core (command) | Preview 1 | 302,371 |
| zlib | `--optimize` | core (command) | Preview 1 | 109,868 |
| zlib | `--optimize=size` | core (command) | Preview 1 | 85,391 |
| zlib | `--component --optimize=size` | component (command) | Preview 3 | 88,564 |
