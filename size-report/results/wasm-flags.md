...
| --- | --- | --- | --- | ---: |
| hello_world | `--optimize=off` | core (command) | Preview 1 | 184,883 |
...
| pi_approx | `--optimize=off` | core (command) | Preview 1 | 185,251 |
...
| zlib | `--optimize=off` | core (command) | Preview 1 | 415,521 |
| zlib | `--optimize` | core (command) | Preview 1 | 152,247 |
| zlib | `--optimize=size` | core (command) | Preview 1 | 124,585 |
| zlib | `--component --optimize=size` | component (command) | Preview 3 | 128,515 |
