...
| --- | --- | --- | --- | ---: |
| hello_world | (none) | core (command) | Preview 1 | 121,577 |
...
| pi_approx | (none) | core (command) | Preview 1 | 121,777 |
...
| zlib | (none) | core (command) | Preview 1 | 291,799 |
| zlib | `--optimize` | core (command) | Preview 1 | 95,801 |
| zlib | `--optimize=size` | core (command) | Preview 1 | 72,837 |
| zlib | `--component --optimize=size` | component (command) | Preview 3 | 74,491 |
