...
(cd ../.. && java --enable-native-access=ALL-UNNAMED -cp target/classes .todo/123-gpu-acceleration/RngCrossover.java)
...
(cd ../.. && java --enable-native-access=ALL-UNNAMED -Dam.ik.gpu.metal.residentMin=1 -cp target/classes .todo/123-gpu-acceleration/MtlSoftF64.java)
(cd ../.. && java --enable-native-access=ALL-UNNAMED -Dam.ik.gpu.metal.residentMin=1 -cp target/classes .todo/123-gpu-acceleration/MtlResidentFloor.java)
(cd ../.. && java --enable-native-access=ALL-UNNAMED -cp target/classes .todo/123-gpu-acceleration/MtlStridedFloor.java)

# the book's shapes, per step: compile once, run at two step counts, diff
(cd ../.. && java -jar target/rontolisp-0.1.0-SNAPSHOT-exec.jar \
   .todo/123-gpu-acceleration/gpt-book-shapes-fast.lisp -o /tmp/b/BenchBook.class --gpu --simd)
