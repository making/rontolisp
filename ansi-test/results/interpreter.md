...
**9,259 / 18,049 tests pass (51.3%)** -- 2,788 fail, 6,002 signal an error.

7 top-level forms could not be read, 1,943 could not be evaluated, 3 did not terminate; every test those forms would have defined is missing from the counts above.
...
| sequences | 2,452 | 1,847 | 147 | 458 | 75.3% | 851 |
...
| **total** | **18,049** | **9,259** | **2,788** | **6,002** | **51.3%** | **1,953** |
