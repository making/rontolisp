...
**8,571 / 17,981 tests pass (47.7%)** -- 2,957 fail, 6,453 signal an error.

7 top-level forms could not be read, 1,961 could not be evaluated, 3 did not terminate; every test those forms would have defined is missing from the counts above.
...
| sequences | 2,452 | 1,705 | 216 | 531 | 69.5% | 852 |
...
| **total** | **17,981** | **8,571** | **2,957** | **6,453** | **47.7%** | **1,971** |
