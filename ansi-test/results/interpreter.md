...
**15,905 / 19,524 tests pass (81.5%)** -- 1,496 fail, 2,123 signal an error.
...
| data-and-control-flow | 1,428 | 1,222 | 73 | 133 | 85.6% | 12 |
...
| **total** | **19,524** | **15,905** | **1,496** | **2,123** | **81.5%** | **388** |
