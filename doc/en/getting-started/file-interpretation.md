...
including a call through a function value, `apply`, or a function calling another
that calls it back -- holds none, so a loop written as tail recursion runs at any
