...
| value | meaning |
|---|---|
| `rontolisp` (default) | This implementation's own dialect: R7RS plus the [SICP-compatibility](sicp.md) and R5RS names, visible to a file with no `(import ...)` and to the REPL. |
