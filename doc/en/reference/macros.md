...
| `ctypecase` | `(ctypecase x (integer body...) (string body...))` | Like `etypecase`; an object whose type matches no clause signals an `error`. Without a restart system this is identical to `etypecase` (not correctable) |
