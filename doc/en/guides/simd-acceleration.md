...
- [**GPU acceleration (`--gpu`)**](gpu-acceleration.md) -- that product, the element-wise transcendentals, and the broadcast / axis-fold / axes-transpose shapes on an NVIDIA device.
