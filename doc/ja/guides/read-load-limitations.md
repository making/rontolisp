...
- **整数は 64 ビットです。** 整数・基数付きトークンは符号付き 64 ビットの範囲で正確に解析され(31 ビットの fixnum 範囲を超える値はフロントエンドと同様にボックス化整数になります)、それを超えるとラップします。比の成分は 31 ビットのままで、任意精度の解析はありません。
