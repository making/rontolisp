...
;;;;
;;;; Run:
;;;;   rontolisp examples/sieve.lisp
;;;;   rontolisp examples/sieve.lisp -o Sieve.class && java Sieve
;;;;   rontolisp examples/sieve.lisp -o sieve.wasm && wasmtime run -W gc sieve.wasm
