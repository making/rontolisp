...
;;;;
;;;; Run:
;;;;   java -jar target/rontolisp-0.1.0-SNAPSHOT-exec.jar examples/nqueens.lisp
;;;;   java -jar ...-exec.jar examples/nqueens.lisp -o Prog.class && java Prog
;;;;   java -jar ...-exec.jar examples/nqueens.lisp -o nqueens.wasm && wasmtime run -W gc nqueens.wasm
