...
;;;;   wasmtime run -W gc --dir . line-numbers.wasm
;;;;
;;;; Run:
;;;;   java -jar target/rontolisp-0.1.0-SNAPSHOT-exec.jar examples/line-numbers.lisp
;;;;   java -jar ...-exec.jar examples/line-numbers.lisp -o LineNumbers.class && java LineNumbers
;;;;   java -jar ...-exec.jar examples/line-numbers.lisp -o ln.wasm && wasmtime run -W gc --dir . ln.wasm
