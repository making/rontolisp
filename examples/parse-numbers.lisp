...
;;;;
;;;; NOTE: the WASM backend needs a preopened directory for file access:
;;;;   wasmtime run -W gc --dir . parse-numbers.wasm
;;;;
;;;; Run:
;;;;   java -jar target/rontolisp-0.1.0-SNAPSHOT-exec.jar examples/parse-numbers.lisp
;;;;   java -jar ...-exec.jar examples/parse-numbers.lisp -o ParseNumbers.class && java ParseNumbers
;;;;   java -jar ...-exec.jar examples/parse-numbers.lisp -o pn.wasm && wasmtime run -W gc --dir . pn.wasm
