...
;;   rontolisp examples/http-handler-cl-who.lisp --system-path src/test/resources/cl-who
;; Run (JVM class; keep the rontolisp jar on the classpath):
;;   rontolisp examples/http-handler-cl-who.lisp -o App.class --system-path src/test/resources/cl-who && \
;;     java -cp target/rontolisp-0.1.0-SNAPSHOT-exec.jar:. App
;; Run (WASI component under wasmtime serve):
;;   rontolisp examples/http-handler-cl-who.lisp -o app.wasm --component --system-path src/test/resources/cl-who && \
