...
;;;;
;;;; Run:
;;;;   java -jar target/rontolisp-0.1.0-SNAPSHOT-exec.jar examples/calc.lisp
;;;;   java -jar ...-exec.jar examples/calc.lisp -o Calc.class && java Calc
;;;;   java -jar ...-exec.jar examples/calc.lisp -o calc.wasm && wasmtime run -W gc calc.wasm
