...
;; checked before use.
;;
;; Start examples/echo-server.lisp first (any backend), then:
;; Run (interpreter):        echo hello | java -jar $JAR examples/echo-client.lisp
;; Run (JVM):                java -jar $JAR examples/echo-client.lisp -o EchoClient.class && \
;;                           echo hello | java EchoClient
;; Run (WASM component):     java -jar $JAR examples/echo-client.lisp -o echo-client.wasm --component && \
