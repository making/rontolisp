...
gzip**, `hello-clack` **362 KiB / 100 KiB gzip**, `httpbin-tiny-routes`
**397 KiB / 109 KiB gzip**, and the component build's three core modules
**190 KiB**. Startup
