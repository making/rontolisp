...
;;;;
;;;; Run:
;;;;   rontolisp examples/roman.lisp
;;;;   rontolisp examples/roman.lisp -o Roman.class && java Roman
;;;;   rontolisp examples/roman.lisp -o roman.wasm && wasmtime run -W gc roman.wasm
