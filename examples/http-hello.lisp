...
;;
;; Run (interpreter):        java -jar $JAR examples/http-hello.lisp
;; Run (JVM):                java -jar $JAR examples/http-hello.lisp -o HttpHello.class && java HttpHello
;; Run (WASM component):     java -jar $JAR examples/http-hello.lisp -o http-hello.wasm --component && \
