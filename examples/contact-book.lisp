...
;;;;
;;;; Run:
;;;;   rontolisp examples/contact-book.lisp
;;;;   rontolisp examples/contact-book.lisp -o ContactBook.class && java ContactBook
;;;;   rontolisp examples/contact-book.lisp -o contact-book.wasm && wasmtime run -W gc contact-book.wasm
