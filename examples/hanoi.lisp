...
;;;;
;;;; Run:
;;;;   rontolisp examples/hanoi.lisp
;;;;   rontolisp examples/hanoi.lisp -o Hanoi.class && java Hanoi
;;;;   rontolisp examples/hanoi.lisp -o hanoi.wasm && wasmtime run -W gc hanoi.wasm
