...
;;;;
;;;; Run:
;;;;   java -jar target/rontolisp-0.1.0-SNAPSHOT-exec.jar examples/sorting.lisp
;;;;   java -jar ...-exec.jar examples/sorting.lisp -o Sorting.class && java Sorting
;;;;   java -jar ...-exec.jar examples/sorting.lisp -o sorting.wasm && wasmtime run -W gc sorting.wasm
