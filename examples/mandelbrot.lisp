...
;;;;   java -jar ...-exec.jar examples/mandelbrot.lisp -o Prog.class && java Prog
;;;;   java -jar ...-exec.jar examples/mandelbrot.lisp -o mandelbrot.wasm && wasmtime run -W gc mandelbrot.wasm
