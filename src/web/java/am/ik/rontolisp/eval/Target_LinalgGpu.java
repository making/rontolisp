 ...
 * {@code libcuda.so.1} and no device to find. {@link LinalgGpu#available()},
 ...
 * substituting all three makes that class -- and with it the whole CUDA binding --
 * unreachable. Adding a new public method to {@code LinalgGpu} that touches the kernels
