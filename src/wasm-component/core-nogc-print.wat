...
;; import-block-nogc-print.bin (the two WASI 0.2 stdio interfaces the --no-gc print
;; micro-adapter binds; see uni-nogc-print.wit). Imports the two lowered functions
;; bridge-nogc-print.wat uses. Exports a memory + cabi_realloc + run only to satisfy
;; `wasm-tools component new`; none of them reach the sliced import block.
(module
