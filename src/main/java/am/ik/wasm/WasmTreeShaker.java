...
public final class WasmTreeShaker {
	...
	private static void skipSimd(byte[] buf, int[] p) {
		...
		switch (sub) {
			...
			// min/max), lane-wise lt masks, v128.bitselect and f64x2.promote_low_f32x4:
			// no immediate.
			case 0x13, 0x14, 0x43, 0x49, 0x52, 0x5F, 0xE0, 0xE1, 0xE3, 0xE4, 0xE5, 0xE6, 0xE7, 0xEC, 0xED, 0xEF, 0xF0,
