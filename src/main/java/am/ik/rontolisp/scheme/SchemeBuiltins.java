...
final class SchemeBuiltins {
	...
	private static final String TABLE = """
			...
			("floor" base value ((x) (if (floatp x) (rontolisp::%scheme-flonum-floor x) (values (floor x)))))
			("ceiling" base value ((x) (if (floatp x) (rontolisp::%scheme-flonum-ceiling x) (values (ceiling x)))))
			("round" base value ((x) (if (floatp x) (rontolisp::%scheme-flonum-round x) (values (round x)))))
			("truncate" base value ((x) (if (floatp x) (rontolisp::%scheme-flonum-truncate x) (values (truncate x)))))
