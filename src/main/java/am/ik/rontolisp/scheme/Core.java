...
enum Core {
	...
	ARROW, GUARD, PARAMETERIZE, DELAY, DELAY_FORCE, CONS_STREAM, DEFINE_SYNTAX, LET_SYNTAX, LETREC_SYNTAX, SYNTAX_RULES,
	SYNTAX_ERROR, ELLIPSIS, UNDERSCORE, RAW, RAW_PREDICATE, UNSPECIFIED, UNSUPPORTED
