...
public final class PackageRegistry {
	...
	private static final Set<String> CL_FUNCTIONS = Set.of(LispNames.FUNCALL, LispNames.ADD, LispNames.SUB,
			...
			LispNames.INTEGER_LENGTH, LispNames.LOGBITP, LispNames.BYTE, LispNames.BYTE_SIZE, LispNames.BYTE_POSITION,
			LispNames.LDB, LispNames.DPB, LispNames.LIST_STAR, LispNames.ACONS, LispNames.ENDP, LispNames.ELT,
			LispNames.RASSOC, LispNames.PAIRLIS, LispNames.COPY_ALIST, LispNames.REVAPPEND, LispNames.NRECONC,
