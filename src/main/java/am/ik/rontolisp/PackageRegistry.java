...
public final class PackageRegistry {
	...
	private static final Set<String> CL_INTERNALS = Set.of(LispNames.REMF_TAIL, LispNames.STRING_CONCAT,
			...
			LispNames.ARRAY_DISP_OFFSET, LispNames.FIND_SYMBOL_STATUS, LispNames.WARN_INTERNAL, LispNames.SCHAR_SET,
			...
			LispNames.CHAR_FOLD_CHAIN, LispNames.SET_XOR_MATCH, LispNames.PPRINT_DISPATCH_DEFAULT, LispNames.OBJ_NEW,
			...
			LispNames.HC_MATCH_INTERNAL, LispNames.HANDLERS_RAN_VAR, LispNames.HANDLER_CLUSTERS_VAR,
			...
			LispNames.PRINT_CASED_WALK_INTERNAL, LispNames.PRINT_CASED_ON_PATH_INTERNAL,
			LispNames.PRINT_CASED_CHAIN_STOP_INTERNAL, LispNames.HOST_GETENV, LispNames.HOST_GETCWD,
