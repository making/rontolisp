...
public final class PackageRegistry {
	...
	private static final Set<String> CL_INTERNALS = Set.of(LispNames.REMF_TAIL, LispNames.STRING_CONCAT,
			...
			LispNames.FILE_ERROR_INTERNAL, LispNames.PACKAGE_ERROR_INTERNAL, LispNames.OPEN_OR_NIL_INTERNAL,
			...
			LispNames.BROADCAST_STREAM_COMPONENTS, LispNames.TWO_WAY_STREAM_CLASS,
