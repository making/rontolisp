...
public final class PackageRegistry {
	...
	private static final Set<String> CL_FUNCTIONS = Set.of(LispNames.FUNCALL, LispNames.ADD, LispNames.SUB,
			...
			LispNames.CONCATENATED_STREAM_STREAMS, LispNames.PATHNAMEP, LispNames.INPUT_STREAM_P,
			LispNames.OUTPUT_STREAM_P, LispNames.OPEN_STREAM_P, LispNames.STREAM_ELEMENT_TYPE, LispNames.CLASS_OF,
			LispNames.CLASS_NAME, LispNames.ALLOCATE_INSTANCE, LispNames.COMPILE,
			...
			LispNames.UNBOUND_SLOT_INSTANCE, LispNames.STREAM_ERROR_STREAM, LispNames.MAKE_PATHNAME,
			LispNames.MERGE_PATHNAMES, LispNames.TRUENAME, LispNames.PATHNAME, LispNames.PARSE_NAMESTRING,
			...
			LispNames.STORE_VALUE, LispNames.REMPROP, LispNames.IMPORT, LispNames.PACKAGE_USE_LIST,
			LispNames.PACKAGE_USED_BY_LIST, LispNames.PACKAGE_SHADOWING_SYMBOLS, LispNames.PATHNAME_HOST,
			LispNames.PATHNAME_DEVICE, LispNames.PATHNAME_VERSION, LispNames.WILD_PATHNAME_P,
			LispNames.ENOUGH_NAMESTRING, LispNames.TRANSLATE_PATHNAME, LispNames.TRANSLATE_LOGICAL_PATHNAME,
			LispNames.LOGICAL_PATHNAME, LispNames.RENAME_FILE, LispNames.FILE_NAMESTRING,
			LispNames.DIRECTORY_NAMESTRING, LispNames.HOST_NAMESTRING, LispNames.NSTRING_UPCASE,
			LispNames.NSTRING_DOWNCASE, LispNames.NSTRING_CAPITALIZE, LispNames.LISP_IMPLEMENTATION_TYPE,
			LispNames.LISP_IMPLEMENTATION_VERSION, LispNames.SOFTWARE_TYPE, LispNames.SOFTWARE_VERSION,
			LispNames.MACHINE_TYPE, LispNames.MACHINE_VERSION, LispNames.MACHINE_INSTANCE, LispNames.SHORT_SITE_NAME,
			LispNames.LONG_SITE_NAME, LispNames.USER_HOMEDIR_PATHNAME, LispNames.COPY_SYMBOL, LispNames.INVOKE_DEBUGGER,
			LispNames.REMOVE_METHOD, LispNames.COMPILE_FILE, LispNames.COMPILE_FILE_PATHNAME, LispNames.MAKE_PACKAGE,
			LispNames.DELETE_PACKAGE, LispNames.RENAME_PACKAGE, LispNames.PACKAGEP, LispNames.PACKAGE_NICKNAMES,
			LispNames.FIND_ALL_SYMBOLS, LispNames.APROPOS, LispNames.APROPOS_LIST, LispNames.PACKAGE_ERROR_PACKAGE);
	...
	private static final Set<String> CL_INTERNALS = Set.of(LispNames.REMF_TAIL, LispNames.STRING_CONCAT,
			...
			LispNames.FIND_SYMBOL_STATUS, LispNames.SUBTYPEP_VALID, LispNames.READ_FROM_STRING_END,
			LispNames.WARN_INTERNAL, LispNames.SCHAR_SET, LispNames.NORMALIZE_STRING, LispNames.IEEE754_DOUBLE_BITS,
	...
	private static final Set<String> CL_EXPORTED_ONLY = Set.of("&ALLOW-OTHER-KEYS", "&AUX", "&BODY", "&ENVIRONMENT",
			...
			"ARITHMETIC-ERROR-OPERATION", "BOOLE", "BREAK", "BROADCAST-STREAM", "BROADCAST-STREAM-STREAMS",
			"CALL-METHOD", "CALL-NEXT-METHOD", "CHAR-INT", "CLEAR-INPUT", "COMPILATION-SPEED", "COMPILED-FUNCTION",
			"COMPILER-MACRO", "COMPILER-MACRO-FUNCTION", "COMPUTE-APPLICABLE-METHODS", "CONCATENATED-STREAM",
			"COPY-STRUCTURE", "DEBUG", "DECLARATION", "DEFINE-METHOD-COMBINATION", "DESCRIBE", "DESCRIBE-OBJECT",
			"DISASSEMBLE", "DRIBBLE", "DYNAMIC-EXTENT", "ECHO-STREAM", "ED", "ENSURE-GENERIC-FUNCTION", "EXTENDED-CHAR",
			"FILE-AUTHOR", "FILE-ERROR-PATHNAME", "FILE-STRING-LENGTH", "FIND-METHOD", "FLOAT-PRECISION",
			"FLOATING-POINT-INEXACT", "FLOATING-POINT-INVALID-OPERATION", "FLOATING-POINT-OVERFLOW",
			"FLOATING-POINT-UNDERFLOW", "FORMATTER", "FTYPE", "FUNCTION-KEYWORDS", "GET-DECODED-TIME",
			"GET-DISPATCH-MACRO-CHARACTER", "GET-MACRO-CHARACTER", "HASH-TABLE", "IGNORABLE", "IGNORE", "INLINE",
			"INSPECT", "INTERACTIVE-STREAM-P", "INVALID-METHOD-ERROR", "INVOKE-RESTART-INTERACTIVELY", "KEYWORD",
			"LOAD-LOGICAL-PATHNAME-TRANSLATIONS", "LOGICAL-PATHNAME-TRANSLATIONS", "LOOP-FINISH",
			"MAKE-DISPATCH-MACRO-CHARACTER", "MAKE-INSTANCES-OBSOLETE", "MAKE-METHOD", "MAKUNBOUND", "METHOD",
			"METHOD-COMBINATION", "METHOD-COMBINATION-ERROR", "METHOD-QUALIFIERS", "NAME-CHAR", "NEXT-METHOD-P", "NIL",
			"NO-APPLICABLE-METHOD", "NO-NEXT-METHOD", "NOTINLINE", "OPTIMIZE", "PATHNAME-MATCH-P",
			...
			"SPACE", "SPECIAL", "SPEED", "STANDARD", "STANDARD-METHOD", "STEP", "STORAGE-CONDITION",
			"STREAM-EXTERNAL-FORMAT", "STRUCTURE-OBJECT", "SYMBOL", "T", "TRACE", "TWO-WAY-STREAM", "UNINTERN",
			"UNTRACE", "UNUSE-PACKAGE", "UPDATE-INSTANCE-FOR-DIFFERENT-CLASS", "UPDATE-INSTANCE-FOR-REDEFINED-CLASS",
