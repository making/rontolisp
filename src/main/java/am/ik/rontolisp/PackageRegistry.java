...
public final class PackageRegistry {
	...
	private static final Set<String> CL_INTERNALS = Set.of(LispNames.REMF_TAIL, LispNames.STRING_CONCAT,
			...
			LispNames.ARRAY_DISP_TARGET, LispNames.ARRAY_DISP_OFFSET, LispNames.FIND_SYMBOL_STATUS,
	...
	private static final Set<String> TORCH_FUNCTIONS = Set.of("TENSOR", "TENSORP", "DATA", "GRAD", "SHAPE", "ITEM",
			...
			"LOG-SOFTMAX", "RELU", "MASKED-FILL", "GATHER", "INDEX-SELECT", "MODULE", "MODULEP", "MODULE-KIND", "FIELD",
			"SET-DATA", "SET-FIELD", "FORWARD", "PARAMETER", "PARAMETERS", "TRAIN", "EVAL", "TRAINING-P", "LINEAR",
			"EMBEDDING", "SEQUENTIAL", "LAYER-NORM", "DROPOUT", "MSE-LOSS", "CROSS-ENTROPY-LOSS", "OPTIMIZER",
			"OPTIMIZERP", "OPTIMIZER-KIND", "OPTIMIZER-PARAMS", "STEP", "STEP-COUNT", "SGD", "ADAM", "PAD-SEQUENCE",
			"SHUFFLED-BATCHES", "PADDING-MASK", "SUBSEQUENT-MASK");
