...
public final class PackageRegistry {
	...
	private static final Set<String> CL_FUNCTIONS = Set.of(LispNames.FUNCALL, LispNames.ADD, LispNames.SUB,
			...
			LispNames.ARRAY_IN_BOUNDS_P, LispNames.MASK_FIELD, LispNames.SCALE_FLOAT, LispNames.FLOAT_RADIX,
	...
	private static final Set<String> CL_EXPORTED_ONLY = Set.of("&ALLOW-OTHER-KEYS", "&AUX", "&BODY", "&ENVIRONMENT",
			...
			"ARITHMETIC-ERROR-OPERATION", "BIT-AND", "BIT-ANDC1", "BIT-ANDC2", "BIT-EQV", "BIT-IOR", "BIT-NAND",
			"BIT-NOR", "BIT-NOT", "BIT-ORC1", "BIT-ORC2", "BIT-XOR", "BOOLE", "BREAK", "BROADCAST-STREAM",
			"BROADCAST-STREAM-STREAMS", "CALL-METHOD", "CALL-NEXT-METHOD", "CHAR-INT", "CLEAR-INPUT",
			...
			"DEBUG", "DECLARATION", "DEFINE-METHOD-COMBINATION", "DESCRIBE", "DESCRIBE-OBJECT", "DISASSEMBLE",
			"DRIBBLE", "DYNAMIC-EXTENT", "ECHO-STREAM", "ECHO-STREAM-INPUT-STREAM", "ECHO-STREAM-OUTPUT-STREAM", "ED",
			"ENSURE-GENERIC-FUNCTION", "EXTENDED-CHAR", "FILE-AUTHOR", "FILE-ERROR-PATHNAME", "FILE-STRING-LENGTH",
			"FIND-METHOD", "FLOAT-PRECISION", "FLOATING-POINT-INEXACT", "FLOATING-POINT-INVALID-OPERATION",
			...
			"IGNORE", "INLINE", "INSPECT", "INTERACTIVE-STREAM-P", "INVALID-METHOD-ERROR",
			"INVOKE-RESTART-INTERACTIVELY", "KEYWORD", "LOAD-LOGICAL-PATHNAME-TRANSLATIONS",
			"LOGICAL-PATHNAME-TRANSLATIONS", "LOOP-FINISH", "MAKE-CONCATENATED-STREAM", "MAKE-DISPATCH-MACRO-CHARACTER",
			"MAKE-ECHO-STREAM", "MAKE-INSTANCES-OBSOLETE", "MAKE-METHOD", "MAKE-TWO-WAY-STREAM", "MAKUNBOUND", "METHOD",
