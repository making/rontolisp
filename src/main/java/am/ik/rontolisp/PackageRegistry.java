...
public final class PackageRegistry {
	...
	private static final Set<String> CL_FUNCTIONS = Set.of(LispNames.FUNCALL, LispNames.ADD, LispNames.SUB,
			...
			LispNames.MASK_FIELD, LispNames.SCALE_FLOAT, LispNames.FLOAT_RADIX, LispNames.FLOAT_SIGN,
			LispNames.FLOAT_DIGITS, LispNames.DECODE_FLOAT, LispNames.INTEGER_DECODE_FLOAT, LispNames.SUBTYPEP,
