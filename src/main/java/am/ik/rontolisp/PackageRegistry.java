...
public final class PackageRegistry {
	...
	private static final Set<String> CL_INTERNALS = Set.of(LispNames.REMF_TAIL, LispNames.STRING_CONCAT,
			...
			LispNames.ARRAY_BECOME_DISPLACED, LispNames.ARRAY_ALIKE, LispNames.ARRAY_DISP_TARGET,
			LispNames.ARRAY_DEFAULT_ELEMENT, LispNames.ARRAY_ADOPT_ELEMENT_TYPE, LispNames.ARRAY_DISP_OFFSET,
			LispNames.ARRAY_UNDISPLACE, LispNames.FIND_SYMBOL_STATUS, LispNames.SUBTYPEP_VALID,
			LispNames.READ_FROM_STRING_END, LispNames.WARN_INTERNAL, LispNames.SCHAR_SET, LispNames.NORMALIZE_STRING,
			...
			LispNames.HC_MATCH_INTERNAL, LispNames.PROGRAM_ERROR_INTERNAL, LispNames.ARITY_SURPLUS_MESSAGE_INTERNAL,
			LispNames.ARITY_MISSING_MESSAGE_INTERNAL, LispNames.FILE_ERROR_INTERNAL, LispNames.OPEN_OR_NIL_INTERNAL,
