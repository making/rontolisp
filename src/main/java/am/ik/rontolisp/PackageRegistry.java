...
public final class PackageRegistry {
	...
	private static final Set<String> CL_FUNCTIONS = Set.of(LispNames.FUNCALL, LispNames.ADD, LispNames.SUB,
			...
			LispNames.LOGORC2, LispNames.ASH, LispNames.INTEGER_LENGTH, LispNames.LOGBITP, LispNames.BYTE,
			...
			LispNames.GET_OUTPUT_STREAM_STRING, LispNames.MAKE_SYNONYM_STREAM, LispNames.SYNONYM_STREAM_SYMBOL,
			LispNames.VECTORP, LispNames.ARRAYP, LispNames.MAKE_STRING, LispNames.REPLACE, LispNames.FILL,
			LispNames.LOWER_CASE_P, LispNames.UPPER_CASE_P, LispNames.CONSTANTP, LispNames.GET_SETF_EXPANSION,
			LispNames.STREAMP, LispNames.SIMPLE_STRING_P, LispNames.MASK_FIELD, LispNames.SCALE_FLOAT,
			LispNames.DECODE_FLOAT, LispNames.SUBTYPEP, LispNames.CHAR_NAME, LispNames.FDEFINITION,
	...
	private static final Set<String> CL_INTERNALS = Set.of(LispNames.REMF_TAIL, LispNames.STRING_CONCAT,
			...
			LispNames.ROW_MAJOR_ASET, LispNames.MAKE_STRING_OUTPUT_STREAM_INTERNAL,
			...
			LispNames.STRING_COMPARE, LispNames.CHAR_FOLD_CHAIN, LispNames.SET_XOR_MATCH,
			...
			LispNames.HB_GUARD_INTERNAL, LispNames.HANDLERS_RAN_VAR, LispNames.HANDLER_CLUSTERS_VAR,
			...
			LispNames.MAKE_DIRECTORIES, LispNames.PATHNAME_SPLIT, LispNames.MAKE_BROADCAST_STREAM_INTERNAL,
			...
			LispNames.PRINT_CASE_FOLD_INTERNAL, LispNames.HOST_GETENV, LispNames.HOST_GETCWD, LispNames.GETENV_OVERRIDE,
			LispNames.GETENV_OVERRIDE_SET);
