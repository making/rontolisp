...
public final class PackageRegistry {
	...
	private static final Set<String> CL_EXPORTED_ONLY = Set.of("&ALLOW-OTHER-KEYS", "&AUX", "&BODY", "&ENVIRONMENT",
			...
			"FILE-AUTHOR", "FILE-STRING-LENGTH", "FIND-METHOD", "FLOAT-PRECISION", "FLOATING-POINT-INEXACT",
			...
			"HASH-TABLE", "IGNORABLE", "IGNORE", "INLINE", "INSPECT", "INTERACTIVE-STREAM-P", "INVALID-METHOD-ERROR",
			...
			"RESTART", "ROOM", "SAFETY", "SET-MACRO-CHARACTER", "SET-SYNTAX-FROM-CHAR", "SHADOW", "SHADOWING-IMPORT",
			"SIMPLE-BASE-STRING", "SLOT-MISSING", "SLOT-UNBOUND", "SPACE", "SPECIAL", "SPEED", "STANDARD",
			"STANDARD-METHOD", "STEP", "STORAGE-CONDITION", "STREAM-EXTERNAL-FORMAT", "STRUCTURE-OBJECT", "SYMBOL", "T",
			"TRACE", "TWO-WAY-STREAM", "UNINTERN", "UNTRACE", "UPDATE-INSTANCE-FOR-DIFFERENT-CLASS",
