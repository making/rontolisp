...
public final class PackageRegistry {
	...
	private static final Set<String> CL_FUNCTIONS = Set.of(LispNames.FUNCALL, LispNames.ADD, LispNames.SUB,
			...
			LispNames.ENDP, LispNames.ELT, LispNames.RASSOC, LispNames.PAIRLIS, LispNames.COPY_ALIST,
			LispNames.REVAPPEND, LispNames.NRECONC, LispNames.MAPLIST, LispNames.MAPCON, LispNames.NOTANY,
