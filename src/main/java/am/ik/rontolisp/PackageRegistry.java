...
public final class PackageRegistry {
	...
	private static final Set<String> CL_FUNCTIONS = Set.of(LispNames.FUNCALL, LispNames.ADD, LispNames.SUB,
			...
			LispNames.RPLACD, LispNames.MAPCAR, LispNames.MAPC, LispNames.REDUCE, LispNames.EVERY, LispNames.SOME,
			LispNames.REMOVE, LispNames.REMOVE_IF, LispNames.NOT, LispNames.NULL, LispNames.ATOM, LispNames.NUMBERP,
