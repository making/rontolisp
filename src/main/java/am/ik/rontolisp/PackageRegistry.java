...
public final class PackageRegistry {
	...
	private static final Set<String> CL_VARIABLES = union(Set.of(LispNames.PACKAGE_VAR,
			...
			LispNames.COMPILE_PRINT_VAR, LispNames.READ_EVAL_VAR, LispNames.READ_SUPPRESS_VAR,
	...
	private static final Set<String> CL_EXPORTED_ONLY = Set.of("&ALLOW-OTHER-KEYS", "&AUX", "&BODY", "&ENVIRONMENT",
			...
			"BOOLE-NAND", "BOOLE-NOR", "BOOLE-ORC1", "BOOLE-ORC2", "BOOLE-SET", "BOOLE-XOR", "BREAK",
			"BROADCAST-STREAM", "BROADCAST-STREAM-STREAMS", "CALL-METHOD", "CALL-NEXT-METHOD", "CHAR-INT",
