...
public final class PackageRegistry {
	...
	private static final Set<String> CL_EXPORTED_ONLY = Set.of("&ALLOW-OTHER-KEYS", "&AUX", "&BODY", "&ENVIRONMENT",
			...
			"ARITHMETIC-ERROR-OPERATION", "BOOLE", "BREAK", "BROADCAST-STREAM", "CALL-METHOD", "CALL-NEXT-METHOD",
			"CHAR-INT", "COMPILATION-SPEED", "COMPILED-FUNCTION", "COMPILER-MACRO", "COMPILER-MACRO-FUNCTION",
			"COMPUTE-APPLICABLE-METHODS", "CONCATENATED-STREAM", "DEBUG", "DECLARATION", "DEFINE-METHOD-COMBINATION",
			"DESCRIBE", "DESCRIBE-OBJECT", "DISASSEMBLE", "DRIBBLE", "DYNAMIC-EXTENT", "ECHO-STREAM", "ED",
			"ENSURE-GENERIC-FUNCTION", "EXTENDED-CHAR", "FILE-AUTHOR", "FIND-METHOD", "FLOAT-PRECISION",
			...
			"INSPECT", "INVALID-METHOD-ERROR", "INVOKE-RESTART-INTERACTIVELY", "KEYWORD",
