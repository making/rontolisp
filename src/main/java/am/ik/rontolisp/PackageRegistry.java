...
public final class PackageRegistry {
	...
	private static final Set<String> CL_INTERNALS = Set.of(LispNames.REMF_TAIL, LispNames.STRING_CONCAT,
			...
			LispNames.FILE_STREAM_ENTRY_INTERNAL, LispNames.WIDE_READ_BYTE_INTERNAL, LispNames.WIDE_WRITE_BYTE_INTERNAL,
			LispNames.WIDE_ELEMENTS_INTERNAL, LispNames.WIDE_POSITION_OCTETS_INTERNAL, LispNames.WIDE_WIDTH_INTERNAL,
			LispNames.READ_OCTET_INTERNAL, LispNames.WRITE_OCTET_INTERNAL, LispNames.FILE_OCTET_LENGTH_INTERNAL,
