...
public final class PackageRegistry {
	...
	private static final Set<String> CL_INTERNALS = Set.of(LispNames.REMF_TAIL, LispNames.STRING_CONCAT,
			...
			LispNames.ARRAY_DEFAULT_ELEMENT, LispNames.ARRAY_DISP_OFFSET, LispNames.FIND_SYMBOL_STATUS,
			...
			LispNames.STRING_COMPARE, LispNames.CHAR_FOLD_CHAIN, LispNames.SET_XOR_MATCH, LispNames.RD_DATUM,
