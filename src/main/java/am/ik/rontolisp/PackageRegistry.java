...
public final class PackageRegistry {
	...
	private static final Set<String> CL_INTERNALS = Set.of(LispNames.REMF_TAIL, LispNames.STRING_CONCAT,
			...
			LispNames.SIMPLE_ARRAY_P_INTERNAL, LispNames.MV_SPILL, LispNames.SET_FILL_POINTER, LispNames.ARRAY_BECOME,
			LispNames.ARRAY_ALIKE, LispNames.ARRAY_DISP_TARGET, LispNames.ARRAY_DISP_OFFSET,
