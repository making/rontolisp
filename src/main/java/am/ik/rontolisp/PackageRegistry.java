...
public final class PackageRegistry {
	...
	private static final Set<String> CL_FUNCTIONS = Set.of(LispNames.FUNCALL, LispNames.ADD, LispNames.SUB,
			...
			LispNames.NUMERATOR, LispNames.DENOMINATOR, LispNames.RATIONAL, LispNames.SYMBOLP, LispNames.STRINGP,
			...
			LispNames.INTEGER_LENGTH, LispNames.LOGBITP, LispNames.LOGTEST, LispNames.BYTE, LispNames.BYTE_SIZE,
			LispNames.BYTE_POSITION, LispNames.LDB, LispNames.DPB, LispNames.DEPOSIT_FIELD, LispNames.LIST_STAR,
			LispNames.ACONS, LispNames.ENDP, LispNames.ELT, LispNames.RASSOC, LispNames.RASSOC_IF, LispNames.PAIRLIS,
			...
			LispNames.DELETE_IF_NOT, LispNames.SUBSTITUTE, LispNames.SUBST, LispNames.NSUBSTITUTE,
			...
			LispNames.MASK_FIELD, LispNames.SCALE_FLOAT, LispNames.FLOAT_RADIX, LispNames.DECODE_FLOAT,
	...
	private static final Set<String> CL_EXPORTED_ONLY = Set.of("&ALLOW-OTHER-KEYS", "&AUX", "&BODY", "&ENVIRONMENT",
			...
			"ARITHMETIC-ERROR-OPERATION", "ARRAY-IN-BOUNDS-P", "BIT-AND", "BIT-ANDC1", "BIT-ANDC2", "BIT-EQV",
			...
			"FIND-METHOD", "FLOAT-DIGITS", "FLOAT-PRECISION", "FLOAT-SIGN", "FLOATING-POINT-INEXACT",
			...
			"HASH-TABLE", "IGNORABLE", "IGNORE", "INLINE", "INSPECT", "INTEGER-DECODE-FLOAT", "INTERACTIVE-STREAM-P",
			"INVALID-METHOD-ERROR", "INVOKE-RESTART-INTERACTIVELY", "KEYWORD", "LDB-TEST",
			"LOAD-LOGICAL-PATHNAME-TRANSLATIONS", "LOGCOUNT", "LOGICAL-PATHNAME-TRANSLATIONS", "LOOP-FINISH",
			...
			"PRINT-NOT-READABLE", "PRINT-NOT-READABLE-OBJECT", "RANDOM-STATE", "RANDOM-STATE-P", "RATIONALIZE",
			"READ-DELIMITED-LIST", "READ-PRESERVING-WHITESPACE", "READER-ERROR", "READTABLEP", "RESTART", "ROOM",
			"SAFETY", "SET", "SET-MACRO-CHARACTER", "SET-SYNTAX-FROM-CHAR", "SHADOW", "SHADOWING-IMPORT",
			"SIMPLE-BASE-STRING", "SIMPLE-BIT-VECTOR-P", "SIMPLE-VECTOR-P", "SLOT-MISSING", "SLOT-UNBOUND", "SPACE",
			"SPECIAL", "SPEED", "STANDARD", "STANDARD-METHOD", "STEP", "STORAGE-CONDITION", "STREAM-ERROR-STREAM",
			"STREAM-EXTERNAL-FORMAT", "STRUCTURE-OBJECT", "SYMBOL", "T", "TRACE", "TWO-WAY-STREAM",
			"TWO-WAY-STREAM-INPUT-STREAM", "TWO-WAY-STREAM-OUTPUT-STREAM", "UNINTERN", "UNTRACE", "UNUSE-PACKAGE",
