...
public final class PackageRegistry {
	...
	private static final Set<String> CL_FUNCTIONS = Set.of(LispNames.FUNCALL, LispNames.ADD, LispNames.SUB,
			...
			LispNames.DIGIT_CHAR_P, LispNames.DIGIT_CHAR, LispNames.MAKE_HASH_TABLE, LispNames.GETHASH,
			LispNames.REMHASH, LispNames.CLRHASH, LispNames.HASH_TABLE_COUNT, LispNames.HASH_TABLE_TEST,
			LispNames.HASH_TABLE_SIZE, LispNames.HASH_TABLE_REHASH_SIZE, LispNames.HASH_TABLE_REHASH_THRESHOLD,
			LispNames.HASH_TABLE_P, LispNames.MAPHASH, LispNames.MAKE_ARRAY, LispNames.AREF, LispNames.VECTOR,
			...
			LispNames.PEEK_CHAR, LispNames.MAKE_STRING_OUTPUT_STREAM, LispNames.GET_OUTPUT_STREAM_STRING,
			LispNames.MAKE_SYNONYM_STREAM, LispNames.VECTORP, LispNames.ARRAYP, LispNames.MAKE_STRING,
			...
			LispNames.FDEFINITION, LispNames.FILE_POSITION, LispNames.FILE_LENGTH, LispNames.FILE_WRITE_DATE,
	...
	private static final Set<String> CL_INTERNALS = Set.of(LispNames.REMF_TAIL, LispNames.STRING_CONCAT,
			LispNames.SEQ_STRING, LispNames.SEQ_INT_VECTOR, LispNames.BLOCK_INTERNAL, LispNames.FN_BLOCK_INTERNAL,
			LispNames.ERROR_INTERNAL, LispNames.PUTHASH, LispNames.ASET, LispNames.ROW_MAJOR_ASET,
			...
			LispNames.NLX_THROW_INTERNAL, LispNames.STRING_COMPARE, LispNames.CHAR_FOLD_CHAIN,
			...
			LispNames.SLEEP_MS, LispNames.MAKE_DIRECTORIES, LispNames.PATHNAME_SPLIT,
