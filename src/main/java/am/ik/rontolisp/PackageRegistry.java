...
public final class PackageRegistry {
	...
	private static final Set<String> CL_FUNCTIONS = Set.of(LispNames.FUNCALL, LispNames.ADD, LispNames.SUB,
			...
			LispNames.INTEGER_DECODE_FLOAT, LispNames.SUBTYPEP, LispNames.CHAR_NAME, LispNames.FDEFINITION,
			LispNames.FILE_POSITION, LispNames.FILE_LENGTH, LispNames.FILE_WRITE_DATE,
			LispNames.ENSURE_DIRECTORIES_EXIST, LispNames.MAKE_BROADCAST_STREAM, LispNames.PATHNAMEP,
			LispNames.INPUT_STREAM_P, LispNames.OUTPUT_STREAM_P, LispNames.OPEN_STREAM_P, LispNames.STREAM_ELEMENT_TYPE,
			LispNames.CLASS_OF, LispNames.CLASS_NAME, LispNames.ALLOCATE_INSTANCE, LispNames.COMPILE,
	...
	private static final Set<String> CL_EXPORTED_ONLY = Set.of("&ALLOW-OTHER-KEYS", "&AUX", "&BODY", "&ENVIRONMENT",
			...
			"INVOKE-RESTART-INTERACTIVELY", "KEYWORD", "LDB-TEST", "LOAD-LOGICAL-PATHNAME-TRANSLATIONS",
			...
			"SIMPLE-BIT-VECTOR-P", "SIMPLE-VECTOR-P", "SLOT-MISSING", "SLOT-UNBOUND", "SPACE", "SPECIAL", "SPEED",
			"STANDARD", "STANDARD-METHOD", "STEP", "STORAGE-CONDITION", "STREAM-ERROR-STREAM", "STREAM-EXTERNAL-FORMAT",
