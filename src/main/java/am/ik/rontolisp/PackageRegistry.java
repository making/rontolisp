...
public final class PackageRegistry {
	...
	private static final Set<String> GEOM_FUNCTIONS = Set.of("TRANSFORM", "MAKE-TRANSFORM", "TRANSLATION-OF",
			...
			"POLYHEDRON", "ARROW", "TRIAD", "FACETS-OF", "VERTICES-OF", "COLOR-OF", "LABEL-OF", "SCALE", "MESH",
			"WIREFRAME", "MESH-TRIANGLE-COUNT", "USER-DATA", "BOUNDS", "LOWER-OF", "UPPER-OF", "BOUNDS-CENTER",
			"BOUNDS-EXTENT", "BOUNDS-UNION", "VOLUME", "CENTROID", "SURFACE-AREA", "UNION", "DIFFERENCE",
			"INTERSECTION", "SECTION", "HISTORY", "*TOLERANCE*");
