...
public final class PackageRegistry {
	...
	private static final Set<String> CL_FUNCTIONS = Set.of(LispNames.FUNCALL, LispNames.ADD, LispNames.SUB,
			...
			LispNames.MAKE_BROADCAST_STREAM, LispNames.PATHNAMEP, LispNames.INPUT_STREAM_P, LispNames.OUTPUT_STREAM_P,
			LispNames.OPEN_STREAM_P, LispNames.STREAM_ELEMENT_TYPE, LispNames.CLASS_OF, LispNames.CLASS_NAME,
			LispNames.ALLOCATE_INSTANCE, LispNames.COMPILE, LispNames.SIMPLE_CONDITION_FORMAT_CONTROL,
	...
	private static final Set<String> CL_EXPORTED_ONLY = Set.of("&ALLOW-OTHER-KEYS", "&AUX", "&BODY", "&ENVIRONMENT",
			...
			"CONCATENATED-STREAM-STREAMS", "COPY-STRUCTURE", "DEBUG", "DECLARATION", "DEFINE-METHOD-COMBINATION",
			"DESCRIBE", "DESCRIBE-OBJECT", "DISASSEMBLE", "DRIBBLE", "DYNAMIC-EXTENT", "ECHO-STREAM",
			"ECHO-STREAM-INPUT-STREAM", "ECHO-STREAM-OUTPUT-STREAM", "ED", "ENSURE-GENERIC-FUNCTION", "EXTENDED-CHAR",
			...
			"MAKE-CONCATENATED-STREAM", "MAKE-DISPATCH-MACRO-CHARACTER", "MAKE-ECHO-STREAM", "MAKE-INSTANCES-OBSOLETE",
			"MAKE-METHOD", "MAKE-TWO-WAY-STREAM", "MAKUNBOUND", "METHOD", "METHOD-COMBINATION",
			"METHOD-COMBINATION-ERROR", "METHOD-QUALIFIERS", "NAME-CHAR", "NEXT-METHOD-P", "NIL",
			...
			"READ-PRESERVING-WHITESPACE", "READER-ERROR", "READTABLEP", "RESTART", "ROOM", "SAFETY", "SET",
			"SET-MACRO-CHARACTER", "SET-SYNTAX-FROM-CHAR", "SHADOW", "SHADOWING-IMPORT", "SIMPLE-BASE-STRING",
			"SLOT-MISSING", "SLOT-UNBOUND", "SPACE", "SPECIAL", "SPEED", "STANDARD", "STANDARD-METHOD", "STEP",
			"STORAGE-CONDITION", "STREAM-ERROR-STREAM", "STREAM-EXTERNAL-FORMAT", "STRUCTURE-OBJECT", "SYMBOL", "T",
			"TRACE", "TWO-WAY-STREAM", "TWO-WAY-STREAM-INPUT-STREAM", "TWO-WAY-STREAM-OUTPUT-STREAM", "UNINTERN",
