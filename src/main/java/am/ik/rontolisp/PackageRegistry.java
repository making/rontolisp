...
public final class PackageRegistry {
	...
	private static final Set<String> CL_EXPORTED_ONLY = Set.of("&ALLOW-OTHER-KEYS", "&AUX", "&BODY", "&ENVIRONMENT",
			...
			"COMPUTE-APPLICABLE-METHODS", "CONCATENATED-STREAM", "COPY-STRUCTURE", "DEBUG", "DECLARATION",
			"DEFINE-METHOD-COMBINATION", "DESCRIBE", "DESCRIBE-OBJECT", "DISASSEMBLE", "DRIBBLE", "DYNAMIC-EXTENT",
			"ECHO-STREAM", "ED", "ENSURE-GENERIC-FUNCTION", "EXTENDED-CHAR", "FILE-AUTHOR", "FIND-METHOD",
			"FLOAT-PRECISION", "FLOATING-POINT-INEXACT", "FLOATING-POINT-INVALID-OPERATION", "FLOATING-POINT-OVERFLOW",
