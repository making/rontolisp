...
public final class PackageRegistry {
	...
	private static final Set<String> CL_FUNCTIONS = Set.of(LispNames.FUNCALL, LispNames.ADD, LispNames.SUB,
			...
			LispNames.NUMERATOR, LispNames.DENOMINATOR, LispNames.RATIONAL, LispNames.RATIONALIZE, LispNames.SYMBOLP,
			...
			LispNames.LOGORC2, LispNames.LOGNAND, LispNames.LOGNOR, LispNames.LOGEQV, LispNames.ASH,
			LispNames.INTEGER_LENGTH, LispNames.LOGBITP, LispNames.LOGTEST, LispNames.LOGCOUNT, LispNames.BYTE,
			LispNames.BYTE_SIZE, LispNames.BYTE_POSITION, LispNames.LDB, LispNames.DPB, LispNames.DEPOSIT_FIELD,
			LispNames.LDB_TEST, LispNames.LIST_STAR, LispNames.ACONS, LispNames.ENDP, LispNames.ELT, LispNames.RASSOC,
			...
			LispNames.USE_PACKAGE, LispNames.UNUSE_PACKAGE, LispNames.EXPORT, LispNames.UNEXPORT, LispNames.FIND_CLASS,
			LispNames.GET, LispNames.SYMBOL_PLIST, LispNames.DIGIT_CHAR_P, LispNames.DIGIT_CHAR,
			...
			LispNames.SYMBOL_VALUE, LispNames.SET, LispNames.FUNCTIONP, LispNames.VALUES_LIST, LispNames.NE,
			LispNames.FILL_POINTER, LispNames.ARRAY_HAS_FILL_POINTER_P, LispNames.ADJUSTABLE_ARRAY_P,
			...
			LispNames.READ_CHAR, LispNames.PEEK_CHAR, LispNames.READ_CHAR_NO_HANG, LispNames.UNREAD_CHAR,
			...
			LispNames.SIMPLE_VECTOR_P, LispNames.BIT_VECTOR_P, LispNames.SIMPLE_BIT_VECTOR_P,
			LispNames.ARRAY_IN_BOUNDS_P, LispNames.BIT_AND, LispNames.BIT_ANDC1, LispNames.BIT_ANDC2, LispNames.BIT_EQV,
			LispNames.BIT_IOR, LispNames.BIT_NAND, LispNames.BIT_NOR, LispNames.BIT_NOT, LispNames.BIT_ORC1,
			LispNames.BIT_ORC2, LispNames.BIT_XOR, LispNames.MASK_FIELD, LispNames.SCALE_FLOAT, LispNames.FLOAT_RADIX,
			LispNames.FLOAT_SIGN, LispNames.FLOAT_DIGITS, LispNames.DECODE_FLOAT, LispNames.INTEGER_DECODE_FLOAT,
			LispNames.SUBTYPEP, LispNames.CHAR_NAME, LispNames.FDEFINITION, LispNames.FILE_POSITION,
			LispNames.FILE_LENGTH, LispNames.FILE_WRITE_DATE, LispNames.ENSURE_DIRECTORIES_EXIST,
			LispNames.MAKE_BROADCAST_STREAM, LispNames.MAKE_TWO_WAY_STREAM, LispNames.TWO_WAY_STREAM_INPUT_STREAM,
			LispNames.TWO_WAY_STREAM_OUTPUT_STREAM, LispNames.MAKE_ECHO_STREAM, LispNames.ECHO_STREAM_INPUT_STREAM,
			LispNames.ECHO_STREAM_OUTPUT_STREAM, LispNames.MAKE_CONCATENATED_STREAM,
			LispNames.CONCATENATED_STREAM_STREAMS, LispNames.BROADCAST_STREAM_STREAMS, LispNames.CLEAR_INPUT,
			LispNames.FILE_STRING_LENGTH, LispNames.INTERACTIVE_STREAM_P, LispNames.STREAM_EXTERNAL_FORMAT,
			...
			LispNames.UNBOUND_SLOT_INSTANCE, LispNames.STREAM_ERROR_STREAM, LispNames.FILE_ERROR_PATHNAME,
			LispNames.MAKE_PATHNAME, LispNames.MERGE_PATHNAMES, LispNames.TRUENAME, LispNames.PATHNAME,
			LispNames.PARSE_NAMESTRING, LispNames.PATHNAME_NAME, LispNames.PATHNAME_TYPE, LispNames.DELETE_FILE,
			LispNames.Y_OR_N_P, LispNames.NAMESTRING_CL, LispNames.COPY_READTABLE,
	...
	private static final Set<String> CL_VARIABLES = union(Set.of(LispNames.PACKAGE_VAR,
			...
			LispNames.MULTIPLE_VALUES_LIMIT, LispNames.BOOLE_1, LispNames.BOOLE_2, LispNames.BOOLE_AND,
			LispNames.BOOLE_ANDC1, LispNames.BOOLE_ANDC2, LispNames.BOOLE_C1, LispNames.BOOLE_C2, LispNames.BOOLE_CLR,
			LispNames.BOOLE_EQV, LispNames.BOOLE_IOR, LispNames.BOOLE_NAND, LispNames.BOOLE_NOR, LispNames.BOOLE_ORC1,
			LispNames.BOOLE_ORC2, LispNames.BOOLE_SET, LispNames.BOOLE_XOR, LispNames.GENSYM_COUNTER_VAR,
			LispNames.RANDOM_STATE_VAR, LispNames.PRINT_ESCAPE_VAR, LispNames.PRINT_READABLY_VAR,
			...
			LispNames.READ_SUPPRESS_VAR, LispNames.PRINT_PRETTY_VAR, LispNames.PRINT_RIGHT_MARGIN_VAR,
	...
	private static final Set<String> CL_TYPES = Set.of("INTEGER", "NUMBER", "RATIONAL", "RATIO", "REAL", "COMPLEX",
			...
			// pkg::name rule): a defgeneric's dispatcher is a plain function, a
			// defstruct's class metaobject is a standard-class and built-in types have
			// no metaobjects -- trivia level2 dispatches typecase/etypecase over them.
	...
	private static final Set<String> CL_INTERNALS = Set.of(LispNames.REMF_TAIL, LispNames.STRING_CONCAT,
			...
			LispNames.ASET, LispNames.CHECK_LIST_INTERNAL, LispNames.READ_SEQUENCE_PACKED,
			LispNames.WRITE_SEQUENCE_PACKED, LispNames.READ_SEQUENCE_CHARS, LispNames.ROW_MAJOR_ASET,
			...
			LispNames.SET_FILL_POINTER, LispNames.ARRAY_BECOME, LispNames.ARRAY_BECOME_DISPLACED, LispNames.ARRAY_ALIKE,
			LispNames.ARRAY_DISP_TARGET, LispNames.ARRAY_DEFAULT_ELEMENT, LispNames.ARRAY_ADOPT_ELEMENT_TYPE,
			LispNames.ARRAY_DISP_OFFSET, LispNames.ARRAY_UNDISPLACE, LispNames.FIND_SYMBOL_STATUS,
			LispNames.SUBTYPEP_VALID, LispNames.READ_FROM_STRING_END, LispNames.WARN_INTERNAL, LispNames.SCHAR_SET,
			LispNames.NORMALIZE_STRING, LispNames.IEEE754_DOUBLE_BITS, LispNames.IEEE754_DOUBLE_FROM_BITS,
			LispNames.IEEE754_SINGLE_BITS, LispNames.IEEE754_SINGLE_FROM_BITS, LispNames.READ_EVAL,
			LispNames.READ_EVAL_TEMPLATE, LispNames.READ_EVAL_UNREADABLE, LispNames.SUBSEQ_CORE,
			...
			LispNames.LL_KEY_CELL, LispNames.LL_CHECK_KEYS, LispNames.RD_DATUM, LispNames.RD_DISPATCH,
			...
			LispNames.ARITY_SURPLUS_MESSAGE_INTERNAL, LispNames.ARITY_MISSING_MESSAGE_INTERNAL,
			LispNames.FILE_ERROR_INTERNAL, LispNames.PACKAGE_ERROR_INTERNAL, LispNames.SYMBOL_IN_PACKAGE_INTERNAL,
			LispNames.FIND_PACKAGE_INTERNAL, LispNames.OPEN_OR_NIL_INTERNAL, LispNames.HANDLERS_RAN_VAR,
			...
			LispNames.BROADCAST_STREAM_CLASS, LispNames.BROADCAST_STREAM_COMPONENTS, LispNames.TWO_WAY_STREAM_CLASS,
			LispNames.TWO_WAY_STREAM_INPUT_INTERNAL, LispNames.TWO_WAY_STREAM_OUTPUT_INTERNAL,
			LispNames.ECHO_STREAM_CLASS, LispNames.ECHO_STREAM_INPUT_INTERNAL, LispNames.ECHO_STREAM_OUTPUT_INTERNAL,
			LispNames.CONCATENATED_STREAM_CLASS, LispNames.CONCATENATED_STREAM_STREAMS_INTERNAL,
			...
			LispNames.FILE_STREAM_ENTRY_INTERNAL, LispNames.FILE_STREAM_FORGET_INTERNAL,
			LispNames.CHARACTER_STREAM_P_INTERNAL, LispNames.CHECK_SEQUENCE_BOUNDS_INTERNAL,
			LispNames.WIDE_READ_BYTE_INTERNAL, LispNames.WIDE_WRITE_BYTE_INTERNAL, LispNames.WIDE_ELEMENTS_INTERNAL,
			LispNames.WIDE_POSITION_OCTETS_INTERNAL, LispNames.WIDE_WIDTH_INTERNAL, LispNames.READ_OCTET_INTERNAL,
			LispNames.WRITE_OCTET_INTERNAL, LispNames.FILE_OCTET_LENGTH_INTERNAL,
			LispNames.FILE_OCTET_POSITION_INTERNAL, LispNames.PROBE_FILE_INTERNAL, LispNames.PATH_NS,
			LispNames.STREAM_TARGET, LispNames.CLOSE_INTERNAL, LispNames.MACRO_FN_INTERNAL,
	...
	private static final Set<String> CL_EXPORTED_ONLY = Set.of("&ALLOW-OTHER-KEYS", "&AUX", "&BODY", "&ENVIRONMENT",
			...
			"*MACROEXPAND-HOOK*", "*READ-BASE*", "++", "+++", "//", "///", "ADD-METHOD", "ARITHMETIC-ERROR-OPERANDS",
			"ARITHMETIC-ERROR-OPERATION", "BOOLE", "BREAK", "CALL-METHOD", "CALL-NEXT-METHOD", "CHAR-INT",
			"COMPILATION-SPEED", "COMPILED-FUNCTION", "COMPILER-MACRO", "COMPILER-MACRO-FUNCTION",
			"COMPUTE-APPLICABLE-METHODS", "DEBUG", "DECLARATION", "DEFINE-METHOD-COMBINATION", "DESCRIBE",
			"DESCRIBE-OBJECT", "DISASSEMBLE", "DRIBBLE", "DYNAMIC-EXTENT", "ED", "ENSURE-GENERIC-FUNCTION",
			"EXTENDED-CHAR", "FILE-AUTHOR", "FIND-METHOD", "FLOAT-PRECISION", "FLOATING-POINT-INEXACT",
			"FLOATING-POINT-INVALID-OPERATION", "FLOATING-POINT-OVERFLOW", "FLOATING-POINT-UNDERFLOW", "FORMATTER",
			"FTYPE", "FUNCTION-KEYWORDS", "GET-DECODED-TIME", "GET-DISPATCH-MACRO-CHARACTER", "GET-MACRO-CHARACTER",
			"HASH-TABLE", "IGNORABLE", "IGNORE", "INLINE", "INSPECT", "INVALID-METHOD-ERROR",
			"INVOKE-RESTART-INTERACTIVELY", "KEYWORD", "LOAD-LOGICAL-PATHNAME-TRANSLATIONS",
			"LOGICAL-PATHNAME-TRANSLATIONS", "LOOP-FINISH", "MAKE-DISPATCH-MACRO-CHARACTER", "MAKE-INSTANCES-OBSOLETE",
			"MAKE-METHOD", "MAKUNBOUND", "METHOD", "METHOD-COMBINATION", "METHOD-COMBINATION-ERROR",
			...
			"RANDOM-STATE", "RANDOM-STATE-P", "READ-DELIMITED-LIST", "READ-PRESERVING-WHITESPACE", "READTABLEP",
			"RESTART", "ROOM", "SAFETY", "SET-MACRO-CHARACTER", "SET-SYNTAX-FROM-CHAR", "SIMPLE-BASE-STRING",
			"SLOT-MISSING", "SLOT-UNBOUND", "SPACE", "SPECIAL", "SPEED", "STANDARD", "STANDARD-METHOD", "STEP",
			"STORAGE-CONDITION", "STRUCTURE-OBJECT", "SYMBOL", "T", "TRACE", "UNTRACE",
