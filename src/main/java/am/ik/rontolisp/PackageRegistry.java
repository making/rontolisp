...
public final class PackageRegistry {
	...
	private static final Set<String> CL_EXPORTED_ONLY = Set.of("&ALLOW-OTHER-KEYS", "&AUX", "&BODY", "&ENVIRONMENT",
			...
			"COMPILER-MACRO", "COMPILER-MACRO-FUNCTION", "COMPUTE-APPLICABLE-METHODS", "CONCATENATED-STREAM", "DEBUG",
			"DECLARATION", "DEFINE-METHOD-COMBINATION", "DESCRIBE", "DESCRIBE-OBJECT", "DISASSEMBLE", "DRIBBLE",
			"DYNAMIC-EXTENT", "ECHO-STREAM", "ED", "ENSURE-GENERIC-FUNCTION", "EXTENDED-CHAR", "FILE-AUTHOR",
			"FILE-STRING-LENGTH", "FIND-METHOD", "FLOAT-PRECISION", "FLOATING-POINT-INEXACT",
			...
			"STORAGE-CONDITION", "STREAM-EXTERNAL-FORMAT", "STRUCTURE-OBJECT", "SYMBOL", "T", "TRACE", "TWO-WAY-STREAM",
			"UNTRACE", "UPDATE-INSTANCE-FOR-DIFFERENT-CLASS", "UPDATE-INSTANCE-FOR-REDEFINED-CLASS",
