...
public final class PackageRegistry {
	...
	private static final Set<String> CL_FUNCTIONS = Set.of(LispNames.FUNCALL, LispNames.ADD, LispNames.SUB,
			...
			LispNames.FIRST, LispNames.SECOND, LispNames.THIRD, LispNames.FOURTH, LispNames.FIFTH, LispNames.SIXTH,
			LispNames.SEVENTH, LispNames.EIGHTH, LispNames.NINTH, LispNames.TENTH, LispNames.NTH, LispNames.PRINT,
