...
public final class PackageRegistry {
	...
	private static final Set<String> CL_INTERNALS = Set.of(LispNames.REMF_TAIL, LispNames.STRING_CONCAT,
			...
			LispNames.PRINT_CASED_INTERNAL, LispNames.PRINT_CASE_FOLD_INTERNAL, LispNames.PRINT_CASED_WALK_INTERNAL,
			LispNames.PRINT_CASED_ON_PATH_INTERNAL, LispNames.PRINT_CASED_CHAIN_STOP_INTERNAL, LispNames.HOST_GETENV,
	...
	private static final Set<String> GEOM_FUNCTIONS = Set.of("TRANSFORM", "MAKE-TRANSFORM", "TRANSLATION-OF",
			...
			"REVOLUTION", "POLYHEDRON", "READ-MODEL", "READ-OBJ", "READ-STL", "ARROW", "TRIAD", "FACETS-OF",
			"VERTICES-OF", "COLOR-OF", "LABEL-OF", "SCALE", "NSCALE", "MESH", "WIREFRAME", "MESH-TRIANGLE-COUNT",
			"USER-DATA", "BOUNDS", "LOWER-OF", "UPPER-OF", "BOUNDS-CENTER", "BOUNDS-EXTENT", "BOUNDS-UNION", "VOLUME",
			"CENTROID", "SURFACE-AREA", "UNION", "DIFFERENCE", "INTERSECTION", "SECTION", "HISTORY", "*TOLERANCE*");
