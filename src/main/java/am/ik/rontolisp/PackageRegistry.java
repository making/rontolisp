...
public final class PackageRegistry {
	...
	private static final Set<String> CL_FUNCTIONS = Set.of(LispNames.FUNCALL, LispNames.ADD, LispNames.SUB,
			...
			LispNames.RPLACD, LispNames.MAPCAR, LispNames.MAPC, LispNames.REDUCE, LispNames.NOT, LispNames.NULL,
			...
			LispNames.LAST, LispNames.REST, LispNames.PRINC_TO_STRING, LispNames.PRIN1_TO_STRING, LispNames.CONCATENATE,
