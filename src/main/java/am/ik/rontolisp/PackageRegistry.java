...
public final class PackageRegistry {
	...
	private static final Set<String> CL_SPECIAL_FORMS = Set.of(LispNames.QUOTE, LispNames.IF, LispNames.LET,
			...
			LispNames.IN_PACKAGE, LispNames.DEFPACKAGE);
	...
	private static final Set<String> CL_FUNCTIONS = Set.of(LispNames.FUNCALL, LispNames.ADD, LispNames.SUB,
			...
			LispNames.WRITE_LINE, LispNames.IDENTITY, LispNames.COPY_LIST, LispNames.NREVERSE, LispNames.MAKE_LIST,
			...
			LispNames.ENDP, LispNames.ELT, LispNames.RASSOC, LispNames.REVAPPEND, LispNames.NRECONC, LispNames.MAPLIST,
			LispNames.MAPCON, LispNames.NOTANY, LispNames.NOTEVERY, LispNames.DELETE, LispNames.DELETE_IF,
			LispNames.DELETE_IF_NOT, LispNames.SUBSTITUTE, LispNames.NSUBSTITUTE, LispNames.GET_UNIVERSAL_TIME,
			LispNames.GET_INTERNAL_REAL_TIME, LispNames.GET_INTERNAL_RUN_TIME, LispNames.GETENV,
			LispNames.READ_FROM_STRING, LispNames.PARSE_INTEGER, LispNames.CHAR, LispNames.SCHAR, LispNames.CHAR_CODE,
			LispNames.CODE_CHAR, LispNames.CHAR_EQ, LispNames.CHAR_LT, LispNames.CHAR_LE, LispNames.CHAR_UPCASE,
