...
public final class PackageRegistry {
	...
	private static final Set<String> CL_MACROS = Set.of(LispNames.BLOCK, LispNames.COND, LispNames.CASE, LispNames.AND,
			...
			LispNames.MACROLET, LispNames.SYMBOL_MACROLET, LispNames.MAKE_CONDITION, LispNames.DOCUMENTATION,
			LispNames.COMPLEMENT, LispNames.COMPLEX, LispNames.WARN, LispNames.SIGNAL, LispNames.RETURN_FROM,
