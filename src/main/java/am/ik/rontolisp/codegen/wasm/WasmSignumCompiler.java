 ...
 * preserved at runtime -- an integer argument yields an integer and a float argument
 * yields a float (-1.0/0.0/1.0) -- by testing whether the value is an i31ref.
 */
final class WasmSignumCompiler {
	...
	static void compile(LispCons cons, WasmLispCompiler.Ctx ctx) {
		...
		// Branch on whether the argument is an integer (i31ref) or a float struct.
		...
		// Integer path: (x > 0) - (x < 0) as an i31ref.
		WasmMathHelper.getI32(ctx, slot);
