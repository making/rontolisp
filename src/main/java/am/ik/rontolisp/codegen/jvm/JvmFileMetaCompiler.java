 ...
 * {@code %make-directories} and {@code file-length} -- as a call of the matching
 * {@code JvmIoRuntimeBuilder} helper. Same shape as {@link JvmProbeFileCompiler}: the
 * argument is compiled to a runtime value and the helper answers rather than signals for
...
final class JvmFileMetaCompiler {
	...
	static void compile(LispCons cons, JvmLispCompiler.Ctx ctx, String className, String name) {
		...
		// All three share the (Object) -> Object shape of the probe-file helper.
