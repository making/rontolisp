...
final class JvmLinalgSimdCompiler {
	...
	private static final Map<String, String> KERNELS = Map.ofEntries(Map.entry(LispNames.LINALG_ADD, "laAdd"),
			...
			Map.entry(LispNames.LINALG_SQRT, "laSqrt"), Map.entry(LispNames.LINALG_ABS, "laAbs"),
			Map.entry(LispNames.LINALG_NEGATIVE, "laNegative"), Map.entry(LispNames.LINALG_SIGN, "laSign"));
