...
public final class BuiltinSystems {
	...
	private static final Map<String, Function<Features, List<LispVal>>> SYSTEMS = Map.ofEntries(
			...
			Map.entry(LispNames.CLACK_HANDLER_CLOUDFLARE_SYSTEM,
					features -> ShimLibraries.forms(LispNames.CLACK_HANDLER_CLOUDFLARE_SYSTEM, features)),
			Map.entry(LispNames.CLACK_HANDLER_CLOUDFLARE_DOTTED_SYSTEM,
					features -> ShimLibraries.forms(LispNames.CLACK_HANDLER_CLOUDFLARE_DOTTED_SYSTEM, features)),
