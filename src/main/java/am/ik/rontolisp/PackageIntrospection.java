...
public final class PackageIntrospection {
	...
	public static final List<String> RONTOLISP_FUNCTION_NAMES = List.of(LispNames.AWAIT, LispNames.CATCH,
			...
			LispNames.LIST_FUNCTIONS, LispNames.LIST_MACROS, LispNames.LIST_SPECIAL_FORMS, LispNames.MAKE_MUTEX,
			...
			LispNames.URL_DECODE, LispNames.URL_ENCODE, LispNames.URL_PATH, LispNames.URL_QUERY, LispNames.VERSION,
