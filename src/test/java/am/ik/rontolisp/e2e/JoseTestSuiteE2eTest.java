...
class JoseTestSuiteE2eTest extends AsdfLibraryE2eSupport {
	...
	private static final List<String> EXPECTED = """
			...
			✓ Expect (JOSE/JWT:DECODE :HS256 JOSE/TESTS/JWT::*SECRET* JOSE/TESTS/JWT::TOKEN) to signal JWT-CLAIMS-ERROR.
			✓ Expect (JOSE/JWT:DECODE :HS256 JOSE/TESTS/JWT::*SECRET* JOSE/TESTS/JWT::TOKEN) to signal JWT-CLAIMS-ERROR.
			✓ Expect (JOSE/JWT:DECODE :HS256 JOSE/TESTS/JWT::*SECRET* JOSE/TESTS/JWT::TOKEN) to signal JWT-CLAIMS-ERROR.
			test-nbf
			✓ Expect (JOSE/JWT:DECODE :HS256 JOSE/TESTS/JWT::*SECRET* JOSE/TESTS/JWT::TOKEN) to be true.
			test-nbf-in-future
			✓ Expect (JOSE/JWT:DECODE :HS256 JOSE/TESTS/JWT::*SECRET* JOSE/TESTS/JWT::TOKEN) to signal JWT-CLAIMS-NOT-YET-VALID.
			✓ Expect (HANDLER-BIND ((JOSE/ERRORS:JWT-CLAIMS-NOT-YET-VALID (FUNCTION CONTINUE))) (JOSE/JWT:DECODE :HS256 JOSE/TESTS/JWT::*SECRET* JOSE/TESTS/JWT::TOKEN)) to be true.
			test-exp
			✓ Expect (JOSE/JWT:DECODE :HS256 JOSE/TESTS/JWT::*SECRET* JOSE/TESTS/JWT::TOKEN) to be true.
			test-exp-in-past
			✓ Expect (JOSE/JWT:DECODE :HS256 JOSE/TESTS/JWT::*SECRET* JOSE/TESTS/JWT::TOKEN) to signal JWT-CLAIMS-EXPIRED.
			✓ Expect (HANDLER-BIND ((JOSE/ERRORS:JWT-CLAIMS-EXPIRED (FUNCTION CONTINUE))) (JOSE/JWT:DECODE :HS256 JOSE/TESTS/JWT::*SECRET* JOSE/TESTS/JWT::TOKEN)) to be true.
			test-skip-verify
			✓ Expect (EQUAL JOSE/TESTS/JWT::CLAIMS (QUOTE (("a" . "b")))) to be true.
			✓ Expect (EQUAL JOSE/TESTS/JWT::HEADERS (QUOTE (("alg" . "HS256") ("typ" . "JWT")))) to be true.
