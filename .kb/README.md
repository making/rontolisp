...
- [simd.md](simd.md) -- `simd:` package (packed-f64 vector kernels over the packed float-array type) + JVM `--simd` (jdk.incubator.vector) and `--no-gc` native `v128` acceleration
