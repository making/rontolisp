...
- [native-output.md](native-output.md) -- `rontolisp-native/`: the wasmtime precompile shim and the runner stub a native executable is made of; the one shared engine config, the fingerprint, the payload trailer, the separate-build trap, the numbers
