...
`RontoLispCliStreamsTest`'s `anUncaught*` cases; Phase 5: `cli/UncaughtReportParityTest` (every
rewrite above that used to drop a function's positions has a case), `am.ik.jvm.LineNumberTableTest`.
