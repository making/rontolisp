...
- **Cost of the rest, measured 2026-09-26**: `zlib` P1 117,008 -> 116,675, size level 89,623 ->
...
- **Open**: a string access's non-string and `(setf char)` index (`.todo/983`).
- Pinned by `ci-spec.yaml`'s `argument-type-errors-name-the-operator-beyond-arithmetic` and
  ...
  `list-consumers-beyond-the-first-set-name-the-operator`, and the
  `argumentTypeErrorsNameTheOperatorBeyondArithmetic` / `listWalksAndStringIndicesNameTheOperator` /
  `listConsumersNameTheOperator` / `listConsumersBeyondTheFirstSetNameTheOperator` triples (`LispEvaluatorTest`, `JvmLispCompilerTest`, `WasmLispCompilerIntegrationTest`).
