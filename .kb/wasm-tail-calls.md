...
16 MiB worker). The JVM figure became 16,201 when the compiled `main` moved onto a 16 MiB
worker the same day ([interpreter-stack.md](interpreter-stack.md)). One Scheme call through a value is two JVM frames, `g` and `_invoke_2`;
