...
- **`java:` interop**: a fourth `java` package with reflection-based interop, supported in the interpreter and JVM compiler (via an embedded bridge class), not WASM. Details: `.kb/java-interop.md`.
